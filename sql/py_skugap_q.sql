-- ══════════════════════════════════════════════════════════════════════════════
-- SKU Gap Recommendation — Peya Platform (v3 — reads pre-materialized lookups)
--
...
--
-- Markets: PY_AR,PY_CL,PY_PE,PY_VE,PY_DO,PY_UY,PY_PY,PY_EC,PY_BO,PY_CR,PY_HN,PY_SV,PY_GT,PY_NI,AP_PA
...
all_vendor_dims AS (
  ...
  WHERE global_entity_id IN ('PY_AR','PY_CL','PY_PE','PY_VE','PY_DO','PY_UY','PY_PY','PY_EC','PY_BO','PY_CR','PY_HN','PY_SV','PY_GT','PY_NI','AP_PA')
...
all_vendor_product_sales AS (
  ...
  WHERE o.global_entity_id IN ('PY_AR','PY_CL','PY_PE','PY_VE','PY_DO','PY_UY','PY_PY','PY_EC','PY_BO','PY_CR','PY_HN','PY_SV','PY_GT','PY_NI','AP_PA')
...
vendor_users AS (
  ...
  WHERE NOT COALESCE(u.is_deleted, FALSE)
    ...
    AND v.global_entity_id IN ('PY_AR','PY_CL','PY_PE','PY_VE','PY_DO','PY_UY','PY_PY','PY_EC','PY_BO','PY_CR','PY_HN','PY_SV','PY_GT','PY_NI','AP_PA')
  GROUP BY ALL
),
