-- ══════════════════════════════════════════════════════════════════════════════
-- SKU Gap Recommendation — Pandora Platform (v3 — reads pre-materialized lookups)
--
...
--
-- Markets: FP_PK,FP_BD,FP_MY,FP_PH,FP_SG,FP_KH,FP_MM,FP_LA,FP_HK,FP_TW,DJ_CZ,NP_HU,OP_SE,FO_NO,MJM_AT,YS_TR
-- Period: May 2026
-- ══════════════════════════════════════════════════════════════════════════════
...
all_vendor_dims AS (
  ...
  WHERE global_entity_id IN ('FP_PK','FP_BD','FP_MY','FP_PH','FP_SG','FP_KH','FP_MM','FP_LA','FP_HK','FP_TW','DJ_CZ','NP_HU','OP_SE','FO_NO','MJM_AT','YS_TR')
...
all_vendor_product_sales AS (
  ...
  WHERE o.global_entity_id IN ('FP_PK','FP_BD','FP_MY','FP_PH','FP_SG','FP_KH','FP_MM','FP_LA','FP_HK','FP_TW','DJ_CZ','NP_HU','OP_SE','FO_NO','MJM_AT','YS_TR')
...
vendor_users AS (
  ...
  WHERE NOT COALESCE(u.is_deleted, FALSE)
    ...
    AND v.global_entity_id IN ('FP_PK','FP_BD','FP_MY','FP_PH','FP_SG','FP_KH','FP_MM','FP_LA','FP_HK','FP_TW','DJ_CZ','NP_HU','OP_SE','FO_NO','MJM_AT','YS_TR')
  GROUP BY ALL
),
