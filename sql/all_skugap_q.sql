-- ══════════════════════════════════════════════════════════════════════════════
-- SKU Gap Recommendation — ALL PLATFORMS (v3 — reads pre-materialized lookups)
--
...
active_skus AS (
  ...
  WHERE date_ref >= '2026-05-01' AND date_ref <= '2026-05-31'
  GROUP BY ALL
...
all_vendor_product_sales AS (
  ...
  WHERE o.order_created_date_lt >= '2026-05-01' AND o.order_created_date_lt <= '2026-05-31'
